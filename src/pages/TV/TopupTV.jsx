...
export default function TopupTV({route}) {
  ...
  const confirmOrder = async () => {
    ...
    console.log('[TV DEBUG] Initiating confirmOrder');
    console.log('[TV DEBUG] current customer_no state:', customer_no);
    console.log('[TV DEBUG] current selectItem state:', JSON.stringify(selectItem, null, 2));
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: isDarkMode ? DARK_BACKGROUND : WHITE_BACKGROUND, paddingBottom: 100}}>
      <CustomHeader title={title || "Topup TV"} />
